...
HERELINK2_IP="192.168.0.105"

# Define the MAVProxy command for Herelink 2
MAVPROXY_COMMAND2="mavproxy.py --master=udpout:$HERELINK2_IP:14552 --out=udp:127.0.0.1:14550"
...
echo "Starting MAVProxy instance 5..."
$MAVPROXY_COMMAND2

# Wait for Ctrl+C to stop the process
echo "MAVProxy instance 5 is running. Press Ctrl+C to stop."
